...
export const getProducts = (keyword = " ", currentPage = 1) => async (dispatch) => {
    ...
    try {
        ...
        //then get all data 
        const { data } = await axios.get(`/api/v1/drinks?keyword=${keyword}&page=${currentPage}`)
...
export const getAdminProducts = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/v1/admin/drinks`)
...
export const newProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`/api/v1/admin/drinks/new`, productData, config, {withCredentials:true})
...
export const deleteProduct = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`/api/v1/admin/drinks/${id}`)
