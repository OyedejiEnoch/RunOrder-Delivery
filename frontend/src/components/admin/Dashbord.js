...
function Dashboard() {
  ...
  const { totalAmount: amount } = useSelector(
    (state) => state.allCafeteriaForm
  );
  const { numberstotalAmount: NumbersAmount } = useSelector(
    (state) => state.allNumbersCafeteriaForm
  );
  ...
  const { mimiestotalAmount } = useSelector(
    (state) => state.allMimiesCafeteriaForm
  );
  const { divinetotalAmount } = useSelector(
    (state) => state.allDivineCafeteriaForm
  );
            ...
            >
              <div className="offcanvas-header">
                <p className="adminName">
                  <i class="fa-solid fa-hand-wave fa-beat-fade"></i>{" "}
                    ...
                    <div className="card o-hidden h-100 dashbordBg">
                      <div className="card-body">
                        <div className="text-center ">
                          Products
                          <br /> <i className="fa-solid fa-cart-shopping"></i>{" "}
                          <b>20</b>
                        </div>
                      </div>
                      <Link
                        className="card-footer learfix small z-1"
                        to="/admin/products"
                      >
                  ...
                  <div className="col-xl-3 col-sm-6 mb-3 dashbordBox">
                    <div className="card o-hidden h-100 dashbordBg">
                      <div className="card-body">
                        <div className="text-center ">
                          Users
                          <br /> <i className="fa-solid fa-users"></i>{" "}
                    ...
                    <div className="card o-hidden h-100 dashbordBg">
                      <div className="card-body">
                        <div className="text-center ">
                          Total Amount
                          <br />{" "}
                          <b>N {totalAmount && totalAmount.toFixed(2)}</b>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-xl-3 col-sm-6 mb-3 dashbordBox">
                    <div className="card o-hidden h-100 dashbordBg">
                      <div className="card-body">
                        <div className="text-center ">
                          MannerPalace
                          <br /> <i className="fa-solid fa-naira-sign"></i>{" "}
                          <b>{amount}</b>
                        </div>
                      </div>
                      <Link
                        className="card-footer clearfix small z-1"
                        to="/admin/mannerPalaceForm"
                      >
                        <span className="float-left">View Details</span>
                        <span className="float-right">
                          <i className="fa fa-angle-right"></i>
                    ...
                    <div className="card o-hidden h-100 dashbordBg">
                      <div className="card-body">
                        <div className="text-center ">
                          Divine Hands
                          <br /> <i className="fa-solid fa-naira-sign"></i>{" "}
                          <b>{divinetotalAmount}</b>
                        </div>
                      </div>
                      <Link
                        className="card-footer clearfix small z-1"
                        to="/admin/divineHands"
                      >
                        <span className="float-left">View Details</span>
                        <span className="float-right">
                          <i className="fa fa-angle-right"></i>
