...
import { newFood, clearErrors } from "../../action/foodActions";
import { useNavigate } from "react-router-dom";
import { NEW_PRODUCTS_RESET } from "../../constants/foodConstants";
...
function NewFood() {
    ...
    const { loading, error, success } = useSelector(state => state.newFoodProduct)
