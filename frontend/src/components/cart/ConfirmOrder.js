...
function ConfirmOrder() {
  ...
  const taxPrice =
    shippingInfo.cafeteria === "Peace Park" ||
    shippingInfo.cafeteria === "Runsa Vendors"
      ? 0
      : 150;
  ...
  const componentProps = {
    ...
    text: "Pay Now",
    onSuccess: () => (
      alert("Thanks for ordering with us! Come back soon!!"),
      proceedToPayment(),
      orderPay()
    ),
    ...
    <Fragment>
      ...
      <div className="row d-flex justify-content-between">
        <div className="col-12 col-lg-8 mt-5 order-confirm">
          ...
          <p className="mb-4">
            <b>Cafeteria:</b> {` ${shippingInfo.cafeteria}`}
          </p>
              ...
              <div className="cart-item " key={item.product}>
                <div className="cartAdjust">
                  ...
                  <div className="cartAdjustPrice">
                    <p>
                      {item.quantity} x{" "}
                      <i className="fa-solid fa-naira-sign"></i> {item.price} ={" "}
                      <b>
                        {" "}
