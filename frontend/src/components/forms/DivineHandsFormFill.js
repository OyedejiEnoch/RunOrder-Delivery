...
import {newCafeteriaForm, clearErrors} from "../../action/divineHandsActions"
import {NEW_FORM_REQUEST} from "../../constants/divineHandsConstants"

const DivineHandsFormFill = () => {
    ...
    const { loading, error, success } = useSelector(state => state.divineHandsCafeteria);
...
export default DivineHandsFormFill
