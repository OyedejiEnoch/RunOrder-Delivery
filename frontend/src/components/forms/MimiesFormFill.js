...
import {newCafeteriaForm, clearErrors} from "../../action/mimiesActions"
import {NEW_FORM_REQUEST} from "../../constants/mimiesConstants"

const MimiesFormFill = () => {
    ...
    useEffect(() => {
        ...
        if (success) {
            ...
            toast.success("Order Noted Please Refresh the Page")
