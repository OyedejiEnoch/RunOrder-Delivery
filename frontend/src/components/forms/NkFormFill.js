...
import {newCafeteriaForm, clearErrors} from "../../action/nationalKitchionActions"
import {NEW_FORM_REQUEST} from "../../constants/nationalKitchenConstants"
...
const NkFormFill = () => {
  ...
  const { loading, error, success } = useSelector(state => state.nkCafeteria);
