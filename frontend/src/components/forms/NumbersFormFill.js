...
import {newCafeteriaForm, clearErrors} from "../../action/numbersActions"
import {NEW_FORM_REQUEST} from "../../constants/numbersConstants"


const NumbersFormFill = () => {
    ...
    const { loading, error, success } = useSelector(state => state.numbersCafeteria);
...
export default NumbersFormFill
