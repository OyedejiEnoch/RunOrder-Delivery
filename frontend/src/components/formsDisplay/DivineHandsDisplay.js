...
import {clearErrors, deleteCafeteriaForm} from "../../action/divineHandsActions"
import { DELETE_FORM_RESET } from "../../constants/divineHandsConstants";
import 'animate.css';

const DivineHandsDisplay = ({forms}) => {

    const dispatch = useDispatch()
    const navigate = useNavigate()

    const { error: deleteError, isDeleted } = useSelector(state => state.divineHands)
...
export default DivineHandsDisplay
