...
import {clearErrors, deleteCafeteriaForm} from "../../action/mannerPalaceActions"
import { DELETE_FORM_RESET } from "../../constants/mannerConstants";
import 'animate.css';


const AgentsDisplayForm = ({forms}) => {
