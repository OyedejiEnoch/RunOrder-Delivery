...
import {clearErrors, deleteCafeteriaForm} from "../../action/mimiesActions"
import { DELETE_FORM_RESET } from "../../constants/mimiesConstants";
import 'animate.css';

const MimiesDisplayForm = ({forms}) => {

    
    const dispatch = useDispatch()
    const navigate = useNavigate()

    const { error: deleteError, isDeleted } = useSelector(state => state.cafeteria)
...
export default MimiesDisplayForm
