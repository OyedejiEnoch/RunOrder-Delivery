...
import {clearErrors, deleteCafeteriaForm} from "../../action/numbersActions"
import { DELETE_FORM_RESET } from "../../constants/numbersConstants";
import 'animate.css';

const NumbersDisplayForm = ({forms}) => {


    const dispatch = useDispatch()
    const navigate = useNavigate()

    const { error: deleteError, isDeleted } = useSelector(state => state.numbers)
...
export default NumbersDisplayForm
