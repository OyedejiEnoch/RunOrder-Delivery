...
function PeaceParkDetails() {
  ...
  const { loading, error, product } = useSelector(
    (state) => state.foodProductDetails
  );

  useEffect(() => {
    dispatch(getPeaceParkDetails(params.id));
  ...
  function addToCart() {
    dispatch(addItemToCart(params.id, quantity, "peacePark"));
          ...
          <div className="row f-flex justify-content-around ">
            ...
            <div className="col-12 col-lg-5 mt-5 productDetails ">
              <div className="productDesc">
                ...
                <h3>
                  <i className="fa-solid fa-exclamation fa-shake"></i>
                </h3>
                <p>
                  {" "}
                  <span className="available">
                    Currently Available only at : {product.seller}{" "}
                  </span>
                </p>
              </div>
...
export default PeaceParkDetails;
