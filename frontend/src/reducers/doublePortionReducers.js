import {
   ...
   export const dpCafeteriaFormReducer = (state = { cafeteriaForms: [] }, action) => {
       switch (action.type) {
           ...
           case ALL_FROM_SUCCESS:
               return {
                   ...
                   dptotalAmount: action.payload.dptotalAmount
               }
   ...
   export const dpNewCafeteriaFormReducer = (state = { doublePortion: {} }, action) => {
       switch (action.type) {
   ...
   export const dpCafeteriaReducer = (state = {}, action) => {
       switch (action.type) {
