...
export const allFoodReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        ...
        case ALL_PRODUCTS_SUCCESS:
            return {
                loading: false,
                products: action.payload.food,
                productsCount: action.payload.foodCount,
...
export const foodDetailsReducer = (state = { product: {} }, action) => {
    switch (action.type) {
...
export const newFoodReducer = (state = { product: {} }, action) => {
    switch (action.type) {
