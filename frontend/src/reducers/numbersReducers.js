import {
   ...
   export const numbersCafeteriaFormReducer = (state = { cafeteriaForms: [] }, action) => {
       switch (action.type) {
           ...
           case ALL_FROM_SUCCESS:
               return {
                   ...
                   numberstotalAmount: action.payload.numberstotalAmount
               }
   ...
   export const newNumbersCafeteriaFormReducer = (state = { numbers: {} }, action) => {
       switch (action.type) {
   ...
   export const numbersCafeteriaReducer = (state = {}, action) => {
       switch (action.type) {
