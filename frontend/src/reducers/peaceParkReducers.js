...
export const allPeaceParksReducer = (state = { products: [] }, action) => {
  switch (action.type) {
    ...
    case ALL_PRODUCTS_SUCCESS:
      return {
        loading: false,
        products: action.payload.peacePark,
        productsCount: action.payload.peaceParkCount,
...
export const peaceParkDetailsReducer = (state = { product: {} }, action) => {
  switch (action.type) {
...
export const newPeaceParkReducer = (state = { product: {} }, action) => {
  switch (action.type) {
...
export const peaceParkReducer = (state = {}, action) => {
  switch (action.type) {
