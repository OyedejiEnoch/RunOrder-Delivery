...
export const allToppingsReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        ...
        case ALL_PRODUCTS_SUCCESS:
            return {
                loading: false,
                products: action.payload.toppings,
                productsCount: action.payload.toppingsCount,
...
export const toppingsDetailsReducer = (state = { product: {} }, action) => {
    switch (action.type) {
...
export const newToppingsReducer = (state = { product: {} }, action) => {
    switch (action.type) {
